<template>
    <div v-if="!passwordStore.password || (passwordStore.password != '7563' && passwordStore.password != '4547' && passwordStore.password != '0499')" class="grow flex items-center justify-center">
