<template>
    <div v-if="!passwordStore.password || (passwordStore.password != 1 && passwordStore.password != 2 && passwordStore.password != 3)" class="grow flex items-center justify-center">
